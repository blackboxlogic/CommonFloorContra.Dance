...
## How To: Website Integration (see [an example](www.commonfloorcontra.dance))
...
## How To: Personal Calendar Integration
...
* If you want performers to easily find your events seeking talent:
...
* An example of searching for events:
